...
public class DataPrep {
    ...
    public static <map> void setData() throws IOException {
        ...
        out = new FileOutputStream("E:\\3. Testing\\DEPI\\Final Project\\my work edit\\ParkBank1.1\\ParkBank\\src\\test\\java\\Data\\data.xlsx");
    ...
    public static void setDataValue(String value, int rowNo, int cellNo)
        ...
        out = new FileOutputStream("E:\\3. Testing\\DEPI\\Final Project\\my work edit\\ParkBank1.1\\ParkBank\\src\\test\\java\\Data\\dataValue.xlsx");
        workbook.write(out);
        out.close();
    }
    ...
    public static CharSequence getData(int rowNo, int cellNo) throws IOException {
        ...
        workbook = new XSSFWorkbook("E:\\3. Testing\\DEPI\\Final Project\\my work edit\\ParkBank1.1\\ParkBank\\src\\test\\java\\Data\\data.xlsx");
